...
public class WheelTime {
    ...
    private TextView wv_hours_tv,wv_minutes_tv;
    private int gravity;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_hours_tv=view.findViewById(R.id.min_str);
        wv_minutes_tv=view.findViewById(R.id.second_str);
        ...
        wv_hours_tv.setVisibility(type[4] ? View.VISIBLE : View.GONE);
        wv_minutes_tv.setVisibility(type[5] ? View.VISIBLE : View.GONE);
        setContentTextSize();
    }
